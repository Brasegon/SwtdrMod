...
public class GuiCustomMainMenu extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 49, j + 100, 98, 20, I18n.format("menu.options")));
        this.buttonList.add(new GuiButton(4, this.width / 2 - 49 + 102, j + 100, 98, 20, I18n.format("menu.quit")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if(button.id == 20)
        {
            FMLClientHandler.instance().connectToServer(this, new ServerData("localserver", "brangers.eu:25565", false));
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int brdline = 0; brdline < brandings.size(); brdline++)
        {
            ...
            {
                this.drawString(this.fontRenderer, brd, 2, this.height - ( 10 ), 16777215);
            }
        }
